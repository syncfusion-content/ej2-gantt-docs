...
var gantt = new ej.gantt.Gantt({
    ...
    showOverAllocation: true,
        ...
        queryTaskbarInfo: function(args) {
            if (args.data.ganttProperties.resourceInfo) {
              if (args.data.ganttProperties.resourceInfo.resourceGroup =='Planning Team') {
                args.progressBarBgColor = 'red';
              }
              else if (args.data.ganttProperties.resourceInfo.resourceGroup =='Testing Team') {
                args.progressBarBgColor = 'yellow';
              }
              else if (args.data.ganttProperties.resourceInfo.resourceGroup =='Approval Team') {
