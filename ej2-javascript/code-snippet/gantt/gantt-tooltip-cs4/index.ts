...
import { Gantt, Selection, DayMarkers } from '../src/index';
...
let labelData = [
  ...
  let editingResources = [
    ...
    const beforeRender = (args :any) => {
        tooltip.content = args.target.currentSrc.split('/')[8].replace('%20', ' ').replace('.png', ''); //To dynamically set the content of the tooltip
      }
