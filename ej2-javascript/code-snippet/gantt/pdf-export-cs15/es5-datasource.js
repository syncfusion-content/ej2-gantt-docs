...
var GanttData = [
...

    {
        ...
        resources: [1],
        subtasks: [
             { TaskID: 7, resources: [2, 3],  TaskName: 'Software Specification', StartDate: new Date('04/02/2019'),
             EndDate: new Date('04/05/2019'), Progress: 40 },
             { TaskID: 8,  TaskName: 'Develop prototype', StartDate: new Date('04/02/2019'),
             EndDate: new Date('04/05/2019'), Progress: 40, isManual: true },
